...
namespace AuthorizationEngine
{
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddSingleton<IPoliciesCheckerEngine, PoliciesCheckerEngine>();
            builder.Services.AddSingleton<IConditionChecker, ConditionChecker>();
